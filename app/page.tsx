...
export default async function LandingPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen text-gray-900 font-sans pt-20 relative overflow-x-hidden">
      ...
      {/* ==========================================
          2. WRAPPER KONTEN BAWAH (Menimpa Hero dengan cepat)
          ========================================== */}
      <div className="relative z-10 bg-white mt-[100vh] shadow-[0_-20px_50px_rgba(0,0,0,0.15)]">
        ...
        <section className="w-full bg-slate-50 py-10 border-y border-slate-100 overflow-hidden flex flex-col items-center">
          <p className="text-xs font-bold uppercase tracking-widest text-slate-400 mb-6 text-center mt-8">
            Our Main Partners
          </p>
