...
export default function DeleteUserButton({ userId, userName, deleteAction }: DeleteButtonProps) {
  return (
    ...
    >
      ...
      <button 
        type="submit" 
        className="w-full flex items-center justify-center text-xs font-semibold text-red-600 bg-red-50 hover:bg-red-100 border border-red-100 px-2.5 py-1.5 rounded-lg transition-all"
      >
